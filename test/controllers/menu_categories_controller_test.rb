...
class MenuCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_category" do
    assert_difference("MenuCategory.count") do
      post menu_categories_url, params: { menu_category: { display_name: @menu_category.display_name, is_active: @menu_category.is_active, slug: @menu_category.slug } }
    end
  ...
  test "should update menu_category" do
    patch menu_category_url(@menu_category), params: { menu_category: { display_name: @menu_category.display_name, is_active: @menu_category.is_active, slug: @menu_category.slug } }
